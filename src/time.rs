...
fn div_duration_f32() {
    ...
    // at these extremes.
    assert!((Duration::MAX).div_duration_f32(Duration::NANOSECOND) > 10000000000000000000000000000.0);
...
fn div_duration_f64() {
    ...
    // Accuracy of the computed value is not a huge concern, we know floats don't work well
    // at these extremes.
    assert!((Duration::MAX).div_duration_f64(Duration::NANOSECOND) > 10000000000000000000000000000.0);
